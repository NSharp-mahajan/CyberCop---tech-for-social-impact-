    ...
    try {
      ...
      if (mockData && mockData.success !== false && mockData) {
        ...
        const firebaseResult: FraudDetectionResult = {
          riskLevel: mockData.riskLevel as 'low' | 'medium' | 'high' | 'critical',
      ...
      const localResult: FraudDetectionResult = {
        riskLevel: analysisResult.riskLevel.toLowerCase() as 'low' | 'medium' | 'high' | 'critical',
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex gap-2">
                              <Badge className={`${getRiskColor(fraudResult.riskLevel || 'low')} border`}>
                                {(fraudResult.riskLevel || 'low').toUpperCase()} RISK
                              </Badge>
                          ...
                          {/* Category */}
                          {fraudResult.category && fraudResult.category !== 'unknown' && (
